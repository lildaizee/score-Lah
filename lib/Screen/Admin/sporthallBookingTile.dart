...
class SporthallTile extends StatelessWidget {
  final SporthallBooking sporthall;
  SporthallTile({this.sporthall});
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Padding(
          ...
          child: Text(
            'Hall No: ${sporthall.selectedHall}',
            style: new TextStyle(
              fontSize: 18.0,
        ...
        subtitle: Padding(
          ...
          child: Text(
            '\nDate: ${sporthall.selectedBookingdate} \nTime: ${sporthall.selectedSlot}',
